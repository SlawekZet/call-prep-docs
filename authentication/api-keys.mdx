...
<Warning>
  ...
  There is no way to retrieve an existing key after it's been shown.
</Warning>

## Product context

Each API key is tied to a **product context** — the name, description, key features,
and target customers of your product. This context is sent to Claude AI for every research request,
