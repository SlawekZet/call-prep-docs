...
**Score property** — the HubSpot contact property that holds the lead score. Defaults to `hs_lead_score` (available on paid HubSpot plans). If you use a custom scoring property, enter its internal name here.

<Tip>
  To find the internal name of a property, go to HubSpot → Settings →
  Properties, click the property, and look for the **internal name** field
...
<Accordion title="I use a custom lead scoring property — how do I find its internal name?">
  In HubSpot, go to **Settings → Properties → Contact properties**, search for
  your scoring property, click on it, and look for the **Internal name** field.
  It's usually lowercase with underscores (e.g. `combined_score_q3_2025`). Enter
  this name in the **Score property** field in CallPrep settings.
</Accordion>
...
<Accordion title="The sync ran but no contacts were found — why?">
  ...
  - The score property name doesn't match what's in HubSpot — double-check the internal name
